...
RSpec.describe "Show page of applicants", type: :feature do
  before :each do
    ...
    @applicant1 = Applicant.create!(name: 'Richie', street_address: "3707 south waco street", city: 'Aurora', state: "Colorado", zip_code: 80013, description: "blah", status: "In Progress")
